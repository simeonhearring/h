...
public final class NumberUtil
{
  ...
  public static Integer toInteger(String inValue, int inDefault)
  {
  ...
  {
    Integer value = inValue != null && !"".equals(inValue.trim()) ? toInteger(inValue) : null;
    return value != null ? value : inDefault;
  }
  ...
  public static int greater(int inInt1, int inInt2)
  {
    return inInt1 > inInt2 ? inInt1 : inInt2;
  }
}