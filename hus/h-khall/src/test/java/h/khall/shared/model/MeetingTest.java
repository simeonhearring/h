...
public class MeetingTest
{
  ...
  public void test3()
  {
    ...
    assigns.add(RandomAssignments.assignment(d, Part.BIBLE_READING, Hall.MAIN, 9, null));
    assigns.add(RandomAssignments.assignment(d, Part.INITIAL_CALL, Hall.MAIN, 10, null));
